...
async function demoEnvironmentVariable() {
  ...
  console.log(`Method executed ${addCalls - explicitStartCalls} times (explicit ON mode overrides env OFF)`);
  ...
  console.log(`Method executed ${addCalls - fallbackStart} times (invalid env falls back to default ON mode)`);
