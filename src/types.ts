...
export interface FastForwardOptions {
  ...
  /**
   * Optional function to transform cache key components
   * Can be used to customize how cache keys are generated by modifying
   * the method name and arguments before they're serialized
   */
  key?: KeyTransformer;
}
